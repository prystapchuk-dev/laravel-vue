  ...
  <div class="py-5 px-8">
    ...
    <div>
      <div v-if="surveyFinished" class="py-8 px-6 bg-emerald-400 text-white w-[600px] mx-auto">
        ...
        <button type="button" @click="submitAnotherResponse" class="inline-flex justify-center py-2 px-4
                                                                    border border-transparent shadow-sm text-sm font-medium
                                                                    rounded-md text-white bg-indigo-600
                                                                    hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Відправити іншу відповідь
        </button>
      </div>
      <div v-else>
        <hr class="my-3"/>
...
const loadind = computed(() => store.state.currentSurvey.loading);
